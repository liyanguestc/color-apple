...
function animate() {
  ...
  for (var i = 0; i < meshArray.length; i++) {
    ...
    case 'apple':
      curMesh.rotation.set(-Math.PI / 2 + 0.2 * Math.sin(3.2 * LEIA.time), 0 *
        Math.PI / 2, -Math.PI / 2 + 0.25 * Math.sin(4 * LEIA.time));
...
function addObjectsToScene() {
  ...
  // world sphere
  var worldTexture = new THREE.ImageUtils.loadTexture(
    'resource/world_texture.jpg');
